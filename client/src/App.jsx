  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-8">
        <h1 className="text-4xl font-bold text-gray-800 mb-2 text-center">Task Manager</h1>
              ...
              <div key={todo._id}>
                {editingTodo === todo._id ? (
                  <div className="flex  items-center gap-x-3">
                    <input className="flex-1 p-3 border rounded-lg border-gray-200 outline-none focus:ring-2
                     focus:ring-blue-300
                    ...
                    <button className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hocer:bg-gray-300 cursor-pointer"
                  ...
                  <div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-x-4 overflow-hidden">
                          ...
                          className={` flex-shrik-0 h-6 w-6 border rounded-full flex items-center justify-center ${todo.completed
                       ...
                       <span className="text-gray-800 font-medium truncate"> 
                        ...
                        <div className="flex gap-x-2 ">
                          ...
                          <button onClick={()=> deleteTodo(todo._id)}  className="p-2 text-red-500
